  ...
  <div>
    ...
    >
      ...
      >
        ...
        >
          <template #default>
            <div
              class="balance-label free-letter-spacing"
            >
              <span>Available balance</span>
            </div>
            <div
              class="mt-10 flex-row align-center"
            >
              <span class="pv-3 ph-7 bg-success radius-3 font-med text-white">S$</span>
              <span class="balance ml-10 font-large text-dark text-bold">{{ humanNumber(bal) }}</span>
            </div>
          </template>
        </flex-col>
        <flex-col
    ...
    >
      ...
      >
        ...
        >
          <span
            class="text-dark text-bold bb-info pb-5 user-debit-cards"
          >
            My debit cards
          </span>
          <span
            class="text-secondary-lite ml-20 pointer-cursor hover-text-bold hover-text-black"
          >
            All Company Cards
          </span>
        </div>
      ...
      <div
        class="cards-container radius-10 mt-10"
      >
        <template
          v-if="cards.length"
        >
          ...
          >
            ...
            >
              <div
                class="mt-10 flex-row justify-center"
              >
                <div
                  class="ph-30"
                >
              ...
              <div
                class="card-navigator-container"
              >
                <div
                  class="flex-row align-center justify-center pt-10"
                >
                  <i
                    v-if="!isFirstCard"
                  ...
                  />
                  <span
                    class="pv-4 ph-10 radius-5 bg-success ml-7 pointer-cursor"
                  />
                  <i
                    v-if="!isLastCard"
            ...
            >
              <div
                class="mt-10 pt-20 details-container"
              >
                <collapse>
                  <collapse-item
                    header-class="radius-5 bg-info-layer text-primary-dark"
                    class="border-gray radius-5"
                    disabled
                    expand-icon="fas fa-angle-down pt-4 pb-3 pl-4 pr-5"
                  ...
                  >
                    <template #header>
                      ...
                      >
                        ...
                        >
                          <img :src="require('@assets/media/svg/card_details.svg')" >
                  ...
                  <collapse-item
                    open
                    header-class="radius-5 bg-info-layer text-primary-dark"
                    class="border-gray radius-5 mt-10"
                    expand-icon="fas fa-angle-down pt-4 pb-3 pl-4 pr-5"
                    collapse-icon="fas fa-angle-right pt-3 pb-2 pl-6 pr-6"
                    icon-class="text-white bg-primary-layer radius-10"
                  >
                    <template #header>
                      ...
                      >
                        <div
                          class="flex-row align-center"
                        >
                          <img :src="require('@assets/media/svg/transactions.svg')" >
                          <span class="ml-10">Recent transitions</span>
                        </div>
                      </div>
                    </template>
                    <template #default>
                      ...
                      >
                        <dashboard-transaction
                          ...
                          class="bt-info-lite pv-10"
                        />
                      </div>
                      <div
                        class="bg-success-layer pv-10 text-success font-medium flex-row justify-center"
                      >
        ...
        >
          <div
            class="flex-row align-center justify-center p-20"
          >
            <div
              class="cards-header"
            >
              <div>
                <span
                  class="font-reg-large text-warning"
                >
...
import { humanNumber } from '@mixins/helpers';
...
@media screen and (max-width:720px){
  ...
  .balance, .balance-label, .user-debit-cards{
    color:white;
  }
...
@media screen and (min-width:720px){
  ...
  .card-actions-container, .card-navigator-container{
    width:330px;
    padding-left:30px;
  }

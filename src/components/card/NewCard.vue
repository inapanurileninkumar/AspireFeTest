<template>
  <div
    class="bg-white p-30 radius-5 new-card-container"
  >
    <div>
      <span
        class="font-large text-secondary"
      >
        New Card
      </span>
    </div>
    ...
    <div
      class="mt-30 flex-row justify-between pv-10 align-center actions-container"
    >
      <div>
        <span
      ...
      <div>
        <span
          class="bg-primary text-white ph-10 pv-5 font-medium-reg radius-5 pointer-cursor"
          @click="addNewCard"
        >
          Submit
        </span>

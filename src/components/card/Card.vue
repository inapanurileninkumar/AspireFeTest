<template>
  ...
  >
    <div
      class="card-info-toggle-container"
    >
      <div
        class="flex-row justify-end"
      >
        <span
          class="text-success font-small text-bold bg-white bg-white pv-7 ph-10 radius-5 pointer-cursor"
    ...
    <div
      :class="[card['active']?'bg-success':'bg-secondary']"
      class=" card radius-10 text-white"
    >
      <div
        class="p-30"
      >
        <div
          class="flex-row justify-end"
        >
          <img :src="require('@assets/media/svg/card_logo.svg')" >
        </div>
        <div
          class="mt-20"
        >
            ...
            >
              ...
              >
                <i
                  v-for="i in 12"
                  :key="i"
                  :class="[(i>1)?([5,9].includes(i)?'ml-15':'ml-3'):'']"
        ...
        <div
          class="mt-10 flex-row align-center font-small text-bold extra-letter-spacing"
        >
          <flex-col
            lg="4"
            xl="4"
        ...
        <div
          class="flex-row justify-end"
        >
          <img :src="require('@assets/media/svg/visa.svg')" >
        </div>
      </div>
    </div>
  </div>
...
.card-info-toggle-container,.card{
    width:330px;
}
.card{
    height:200px;
